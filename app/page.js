    ...
    <>
      ...
      >
        ...
        <Button
          variant="contained"
          color="secondary"
          sx={{ mt: 4, mr: 2, borderRadius: '50px', px: 4 }}
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              ...
              <Typography sx={{ color: 'grey.400' }}>
                Simply enter your text, and let our intuitive software handle the
                rest. Creating flashcards has never been so effortless.
              </Typography>
            </Grid>
            <Grid item xs={12} md={4}>
              <Typography variant="h6" sx={{ color: 'white', mb: 2 }}>
              ...
              <Typography sx={{ color: 'grey.400' }}>
                Powered by AI, our tool expertly distills your text into clear,
                concise flashcards, perfectly tailored for effective studying.
              </Typography>
            </Grid>
            <Grid item xs={12} md={4}>
              <Typography variant="h6" sx={{ color: 'white', mb: 2 }}>
              ...
              <Typography sx={{ color: 'grey.400' }}>
                Whether you're on the go or at home, access your flashcards from any
                device, at any time. Study seamlessly wherever you are.
              </Typography>
            </Grid>
          </Grid>
        </Container>
